...
print(boxes)
print(classIDs)
idxs = cv2.dnn.NMSBoxes(boxes, confidences, args["confidence"], 0)
...
if len(idxs) > 0:
    ...
    for i in idxs.flatten():
        ...
        #cv2.putText(image, str((x)), (x, y - 50), cv2.FONT_HERSHEY_SIMPLEX, 0.4, black, 1)
        #cv2.putText(image, str((y)), (x, y - 20), cv2.FONT_HERSHEY_SIMPLEX, 0.4, black, 1)
        cv2.putText(image, text, (x, y - 5), cv2.FONT_HERSHEY_SIMPLEX, 0.5, black, 1)
print(xcoord_dict)
